...
/// <summary>
/// Summary description for SalesPerPaymentTotal
/// </summary>
public class SalesPerPaymentTotal : DevExpress.XtraReports.UI.XtraReport
   {
   ...
   private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SalesPerPaymentTotal));
    ...
    "ype, Description\r\nFrom Accounts\r\nOrder By Description\r\n";
         ...
         this.xrPageInfo1.LocationFloat = new DevExpress.Utils.PointFloat(1.000508F, 1.387723F);
         ...
         this.xrLabel21.Text = "Πωλήσεις ανά Χειριστή και Τρόπο Πληρωμής Συνοπτικά";
    ...
    "tId) And [PosInfoId] In (?PosInfoID) And [AccountType] In (?AccountType)";
         ...
         this.StyleSheet.AddRange(new DevExpress.XtraReports.UI.XRControlStyle[] {
            ...
            this.DataField});
         this.Version = "15.2";
         this.ParametersRequestBeforeShow += new System.EventHandler<DevExpress.XtraReports.Parameters.ParametersRequestEventArgs>(this.SalesPerPaymentTotal_ParametersRequestBeforeShow);
         this.DataSourceDemanded += new System.EventHandler<System.EventArgs>(this.SalesPerPaymentTotal_DataSourceDemanded);
   ...
   /// <param name="e"></param>
   private void SalesPerPaymentTotal_DataSourceDemanded( object sender, EventArgs e )
      {
   ...
   /// <param name="sender"></param>
   /// <param name="e"></param>
   private void SalesPerPaymentTotal_ParametersRequestBeforeShow( object sender
