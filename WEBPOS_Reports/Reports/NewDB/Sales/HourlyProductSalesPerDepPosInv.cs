...
/// <summary>
/// Summary description for HourlyProductSalesPerDepPosInv
/// </summary>
public class HourlyProductSalesPerDepPosInv : DevExpress.XtraReports.UI.XtraReport
   {
   ...
   private GroupHeaderBand PosInfo_GroupHeader;
   ...
   public HourlyProductSalesPerDepPosInv()
      {
      InitializeComponent();
      //
   ...
   private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HourlyProductSalesPerDepPosInv));
         ...
         this.PosInfo_GroupHeader = new DevExpress.XtraReports.UI.GroupHeaderBand();
         ...
         customSqlQuery6.Sql = "select Id, Type, Abbreviation from InvoiceTypes";
         ...
         this.xrLabel25.LocationFloat = new DevExpress.Utils.PointFloat(505.7139F, 2F);
         ...
         this.xrLabel26.LocationFloat = new DevExpress.Utils.PointFloat(588.6019F, 2F);
         ...
         this.HourOfDay.Type = typeof(int);
         // 
         // sqlDataSource2
         // 
         ...
         this.xrLabel11.SizeF = new System.Drawing.SizeF(725.0002F, 16F);
         ...
         // PosInfo_GroupHeader
         // 
         this.PosInfo_GroupHeader.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrLabel16});
         this.PosInfo_GroupHeader.GroupFields.AddRange(new DevExpress.XtraReports.UI.GroupField[] {
            new DevExpress.XtraReports.UI.GroupField("PosInfoId", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
         this.PosInfo_GroupHeader.HeightF = 15F;
         this.PosInfo_GroupHeader.Level = 3;
         this.PosInfo_GroupHeader.Name = "PosInfo_GroupHeader";
         // 
         // xrLabel16
         // 
         ...
         this.xrLabel16.SizeF = new System.Drawing.SizeF(725.0002F, 15F);
         ...
         this.InvoiceType_GroupHeader.HeightF = 15F;
         this.InvoiceType_GroupHeader.Level = 2;
         ...
         this.xrLabel18.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Query.Abbreviation", "Invoice Type: {0}")});
         ...
         this.xrLabel18.SizeF = new System.Drawing.SizeF(725.0002F, 15F);
         ...
         // 
         // HourlyProductSalesPerDepPosInv
         // 
         ...
         this.FilterString = "[FODay] >= ?FromFODay And [FODay] <= ?UpToFODay And [HourOfDay] In (?HourOfDay) A" +
    "nd [DepartmentId] In (?DepartmentId) And [PosInfoId] In (?PosInfoId) And [Invoic" +
    "eType] In (?InvoiceType)";
         ...
         this.StyleSheet.AddRange(new DevExpress.XtraReports.UI.XRControlStyle[] {
            ...
            this.DataField});
         this.Version = "15.2";
         this.DataSourceDemanded += new System.EventHandler<System.EventArgs>(this.HourlyProductSalesPerDepPosInv_DataSourceDemanded);
         this.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.HourlyProductSalesPerDepPosInv_BeforePrint);
   ...
   /// <param name="e"></param>
   private void HourlyProductSalesPerDepPosInv_BeforePrint( object sender, System.Drawing.Printing.PrintEventArgs e )
      {
   ...
   /// <param name="sender"></param>
   /// <param name="e"></param>
   private void HourlyProductSalesPerDepPosInv_DataSourceDemanded( object sender, EventArgs e )
      {
