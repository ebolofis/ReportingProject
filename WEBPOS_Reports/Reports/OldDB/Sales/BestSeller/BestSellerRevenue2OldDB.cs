...
/// <summary>
/// Summary description for BestSellerRevenue2OldDB
/// </summary>
public class BestSellerRevenue2OldDB : DevExpress.XtraReports.UI.XtraReport
   {
   ...
   public BestSellerRevenue2OldDB()
      {
      try
         {
         InitializeComponent();
   ...
   private void InitializeComponent()
      {
         ...
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BestSellerRevenue2OldDB));
    ...
    ",8,10,11,12) \r\nORDER BY Type";
         ...
         this.ReportHeader.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrLabel31,
            this.xrLabel1});
         this.ReportHeader.HeightF = 24.25002F;
         ...
         this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(6.000061F, 2F);
         this.xrLabel1.Name = "xrLabel1";
         this.xrLabel1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
         this.xrLabel1.SizeF = new System.Drawing.SizeF(607.9999F, 21.20834F);
         ...
         this.xrLabel31.LocationFloat = new DevExpress.Utils.PointFloat(614F, 2F);
         this.xrLabel31.Name = "xrLabel31";
         this.xrLabel31.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
         this.xrLabel31.SizeF = new System.Drawing.SizeF(443F, 21.20834F);
         this.xrLabel31.StylePriority.UseBorders = false;
         this.xrLabel31.StylePriority.UseFont = false;
         this.xrLabel31.StylePriority.UseTextAlignment = false;
         this.xrLabel31.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopLeft;
         // 
         // BestSellerRevenue2OldDB
         // 
         ...
         this.Parameters.AddRange(new DevExpress.XtraReports.Parameters.Parameter[] {
            ...
            this.InvoiceType});
         this.Version = "15.2";
         this.ParametersRequestBeforeShow += new System.EventHandler<DevExpress.XtraReports.Parameters.ParametersRequestEventArgs>(this.BestSellerRevenue2OldDB_ParametersRequestBeforeShow);
         this.DataSourceDemanded += new System.EventHandler<System.EventArgs>(this.BestSellerRevenue2OldDB_DataSourceDemanded);
   ...
   /// <param name="e"></param>
   private void BestSellerRevenue2OldDB_ParametersRequestBeforeShow( object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e )
      {
      sqlDataSource1.Fill();
   ...
   /// <param name="sender"></param>
   /// <param name="e"></param>
   private void BestSellerRevenue2OldDB_DataSourceDemanded( object sender, EventArgs e )
      {
